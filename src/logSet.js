...
module.exports = (connection, setData) => {
    for (let i = 0; i < setData.sets; i++) {
        ...
        connection.connect((err) => {
            ...
            connection.query(`INSERT INTO lifts (userID, movement, weight, reps, date, settotal, dateval) VALUES('${setData.userid}', '${setData.movement}', ${setData.weight}, ${setData.reps}, '${setData.date}', ${setTotal}, ${Date.parse(setData.date)});`, (err2, result) => {
